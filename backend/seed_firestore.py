...
products = [
    # Nike
    {
        ...
        "rating": 4.8,
        "seller_id": "seed-seller-nike",
        "sellerId": "seed-seller-nike",
    ...
    # Samsung
    {
        ...
        "rating": 4.9,
        "seller_id": "seed-seller-samsung",
        "sellerId": "seed-seller-samsung",
        "createdAt": datetime.utcnow().isoformat(),
        "is_published": True,
    },
    {
    ...
    # Apple
    {
        ...
        "rating": 4.9,
        "seller_id": "seed-seller-apple",
        "sellerId": "seed-seller-apple",
        "createdAt": datetime.utcnow().isoformat(),
        "is_published": True,
    },
    {
    ...
    # Adidas
    {
        ...
        "rating": 4.7,
        "seller_id": "seed-seller-adidas",
        "sellerId": "seed-seller-adidas",
        "createdAt": datetime.utcnow().isoformat(),
        "is_published": True,
    },
    {
    ...
    # Sony
    {
        ...
        "rating": 4.9,
        "seller_id": "seed-seller-sony",
        "sellerId": "seed-seller-sony",
        "createdAt": datetime.utcnow().isoformat(),
        "is_published": True,
    },
    {
    ...
    # Logitech
    {
        ...
        "rating": 4.8,
        "seller_id": "seed-seller-logitech",
        "sellerId": "seed-seller-logitech",
        "createdAt": datetime.utcnow().isoformat(),
        "is_published": True,
    },
    {
